...
import com.tiantian.result.ParameterInvalidItem;
import com.tiantian.utils.util.ParameterInvalidItemUtil;
...
public class BaseGlobalExceptionHandler {
	...
	protected DefaultErrorResult handleRuntimeException(RuntimeException e, HttpServletRequest request) {
		...
		return DefaultErrorResult.failure(ResultCode.SYSTEM_INTERNAL_ERROR, e, HttpStatus.INTERNAL_SERVER_ERROR);
	}
